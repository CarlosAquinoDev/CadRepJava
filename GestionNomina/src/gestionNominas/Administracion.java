...
public class Administracion extends Persona implements Serializable{

    public Administracion(String nombre, String telefono, Fecha fechaNacimiento, String dni, CuentaBancaria cuentaBancaria, Contrato contrato) {
